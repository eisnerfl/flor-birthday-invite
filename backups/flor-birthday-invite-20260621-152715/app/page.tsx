    ...
    <div className="fixed inset-0 z-50 grid place-items-center overflow-hidden bg-sky px-5 text-ink">
      ...
      <div className="relative z-10 flex w-full max-w-lg flex-col items-center text-center">
        ...
        <p className="font-display text-5xl font-black uppercase leading-[0.88] sm:text-7xl">
          estas invitado al cumple de flor
        </p>
        <button
...
function CountdownPanel() {
  ...
  return (
    <div className="grid grid-cols-4 rounded-lg border-2 border-ink bg-cream p-2 text-ink shadow-hard">
      {units.map(([label, value]) => (
        <div key={label} className="px-2 py-3 text-center">
          <div className="text-2xl font-black sm:text-3xl">{String(value).padStart(2, "0")}</div>
          <div className="mt-1 text-[10px] font-black uppercase tracking-[0.18em] text-ink/62">
            {label}
          </div>
        </div>
      ))}
      ...
      <section className="hero-stage relative flex min-h-screen w-full items-center overflow-hidden px-4 py-10 sm:px-6">
        ...
        <header className="absolute left-0 right-0 top-0 z-20 flex items-center justify-between px-4 py-5 sm:px-6 md:px-10">
          ...
          <nav className="hidden items-center gap-8 text-sm font-black uppercase tracking-[0.16em] text-ink/80 md:flex">
            ...
            <a href="#kino" className="transition-colors hover:text-ink">
              Kino
            </a>
        ...
        <div className="relative z-10 mx-auto flex w-full max-w-5xl flex-col items-center pt-28 text-center sm:pt-36 md:pt-44">
          ...
          <p className="animate-fade-up delay-3 mt-5 max-w-md text-2xl font-black leading-tight text-ink sm:mt-6 md:text-3xl">
            {INVITE.dateLabel} Â· {INVITE.timeLabel}
          </p>
        ...
        <div className="relative z-10 mx-auto flex max-w-5xl flex-col gap-10">
          <div id="details" className="grid gap-5 rounded-3xl bg-emerald/45 p-6 backdrop-blur-sm sm:p-8">
            ...
            <div className="grid gap-5">
              ...
              <DetailItem icon={<MapPin size={20} />} label="Location" value={INVITE.location} />
            </div>
          </div>

          <div
            id="kino"
            className="mx-auto w-full max-w-3xl rounded-2xl border-2 border-ink bg-yellow/95 p-5 text-center text-ink shadow-hard sm:p-7"
          >
            <p className="text-xs font-black uppercase tracking-[0.24em]">Entrada</p>
            <h2 className="font-display mt-3 text-2xl font-black uppercase leading-[1.02] sm:text-4xl">
              que estos 36 vengan con suerte, llamemosla juntos, ven con un kino
            </h2>
          </div>
          ...
          <div id="rsvp" className="grid gap-6 rounded-3xl bg-cream/92 p-5 text-ink shadow-hard backdrop-blur-md sm:p-7 lg:grid-cols-[0.75fr_1.25fr] lg:items-start">
            <div>
              ...
              <h2 className="font-display mt-3 text-4xl font-black uppercase leading-none sm:text-5xl">
                Confirmá asistencia
              </h2>
              <p className="mt-4 max-w-md text-base font-bold leading-7 text-ink/72">
                Confirmá asistencia y contame si tienes alguna alergia, intolerancia o restricción
                alimentaria.
              </p>
            </div>
          ...
          <div className="pb-6 pt-2 text-center">
            <p className="font-display mx-auto max-w-2xl text-4xl font-black uppercase leading-none text-cream sm:text-6xl">
              Can&apos;t wait to celebrate with you.
            </p>
            <p className="mt-6 text-3xl font-black text-yellow">Flor</p>
          </div>
        </div>
      </section>
    </main>
