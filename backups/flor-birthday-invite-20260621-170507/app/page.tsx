  ...
  if (status === "success") {
    return (
      <div className="flex flex-col items-center gap-3 rounded-2xl border-2 border-ink bg-emerald/10 p-8 text-center">
        ...
        <p className="text-sm font-black uppercase tracking-wide text-ink/60">Tu respuesta fue registrada</p>
      </div>
    );
  }
  ...
  return (
    <form onSubmit={handleSubmit} className="grid gap-5">
      <div className="grid gap-2">
        <label className="text-xs font-black uppercase tracking-[0.18em] text-ink/60">Tu nombre</label>
        <input
          type="text"
          value={nombre}
      ...
      <div className="grid gap-2">
        <label className="text-xs font-black uppercase tracking-[0.18em] text-ink/60">¿Confirmás asistencia?</label>
      ...
      {asiste === "si" && (
        <>
          <div className="grid gap-2">
            <label className="text-xs font-black uppercase tracking-[0.18em] text-ink/60">¿Venís con acompañante?</label>
            <div className="flex gap-3">
          ...
          {acompanante === "si" && (
            <div className="grid gap-2">
              <label className="text-xs font-black uppercase tracking-[0.18em] text-ink/60">Nombre del acompañante</label>
              <input
                type="text"
          ...
          <div className="grid gap-2">
            <label className="text-xs font-black uppercase tracking-[0.18em] text-ink/60">Preferencia de bebida / intolerancias</label>
            <textarea
              value={mensaje}
